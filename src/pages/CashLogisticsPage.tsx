                    ...
                    <div className="absolute inset-0 flex items-start md:items-center pt-40 md:pt-32">
                        <div className="container mx-auto px-4 lg:px-8 relative z-10">
                            <div className="max-w-4xl">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-foreground leading-tight mb-6 animate-fade-in">{cashLogisticsHero.title}</h1>
                                <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-in">{cashLogisticsHero.subtitle}</p>
