...
import secureLogistics1 from "../assets/secure_logistics_1.jpg";
import secureLogistics2 from "../assets/secure_logistics_2.jpg";
...
const heroSlides = [
    { image: secureLogistics1 },
    { image: secureLogistics2 },
                        ...
                        <div className="container mx-auto px-4 lg:px-8 relative z-10">
                            <div className="max-w-4xl">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-card/80 backdrop-blur-sm border border-border rounded-full mb-8 animate-fade-in">
                                    <span className="text-sm font-medium text-primary">{secureLogisticsHero.badge}</span>
                                </div>
                                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-foreground leading-tight mb-6 animate-fade-in">{secureLogisticsHero.title}</h1>
                                <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-in">{secureLogisticsHero.subtitle}</p>
